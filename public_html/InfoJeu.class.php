...
class InfoJeuLoL extends InfoJeu {
  ...
  public function recup_id()
  {
    ...
    if ($tab == NULL) echo 'ERROR';
    $this->_summId = $tab[$this->_pseudo]['id'];
  }
  ...
  public function afficheDonnees()
  {
    ...
    print_r($this->_donnees[1]);
    if (is_array($this->_donnees[0])) {
      foreach($this->_donnees[0] as $k => $v) {
	echo $_SESSION["text"]["type"] . ' : ' . $v;
      }
    } else {
      echo $this->_donnees[0];
    }
    echo '<br />';
